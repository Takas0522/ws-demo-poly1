...
export const translations: Record<Language, Translations> = {
  en: {
    ...
    permissionInfoText:
      "This demo shows different ways to implement button-level authorization. Use the Permission Debugger (bottom-right) to test different scenarios.",
    ...
    confirmCreateMessage:
      "Please review the tenant information before creating:",
    ...
    confirmRemoveTenant:
      "Are you sure you want to remove this tenant assignment?",
    adding: "Adding...",
    edit: "Edit",
    primary: "Primary",
    secondary: "Secondary",
  ...
  ja: {
    ...
    upgradeToPremium:
      "🔒 この機能にアクセスするにはプレミアムにアップグレードしてください",
    ...
    permissionInfoText:
      "このデモでは、ボタンレベルの認可を実装するさまざまな方法を示しています。権限デバッガー（右下）を使用して、さまざまなシナリオをテストしてください。",
    ...
    confirmDelete: "削除の確認",
    confirmDeleteMessage:
      "このテナントを削除してもよろしいですか？この操作は元に戻せません。",
    ...
    failedToUpdateTenant:
      "テナントの更新に失敗しました。もう一度お試しください。",
    failedToAssignAdmin:
      "管理者の割り当てに失敗しました。もう一度お試しください。",
    failedToRemoveAdmin: "管理者の削除に失敗しました。もう一度お試しください。",
    failedToDeleteTenant:
      "テナントの削除に失敗しました。もう一度お試しください。",
    failedToCreateTenant:
      "テナントの作成に失敗しました。もう一度お試しください。",
    ...
    addTenant: "テナント追加",
    selectRoles: "ロールを選択",
    pleaseSelectTenantAndRoles:
      "テナントと少なくとも1つのロールを選択してください",
