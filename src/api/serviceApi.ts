    ...
    features: [
      {
        id: "f1",
        name: "ファイルアップロード",
        description: "基本的なファイルアップロード機能",
        enabled: true,
      },
      {
        id: "f2",
        name: "バージョン管理",
        description: "ファイルのバージョン履歴管理",
        enabled: true,
      },
      {
        id: "f3",
        name: "高度な検索",
        description: "ファイル内容の全文検索",
        enabled: false,
      },
    ],
    version: "2.1.0",
    ...
    features: [
      {
        id: "f4",
        name: "テキストチャット",
        description: "1対1およびグループチャット",
        enabled: true,
      },
      {
        id: "f5",
        name: "ビデオ通話",
        description: "HD品質のビデオ通話",
        enabled: true,
      },
      {
        id: "f6",
        name: "画面共有",
        description: "リアルタイム画面共有",
        enabled: false,
      },
    ],
    version: "1.8.5",
    ...
    features: [
      {
        id: "f13",
        name: "REST API",
        description: "RESTful API アクセス",
        enabled: true,
      },
      {
        id: "f14",
        name: "Webhook",
        description: "イベント駆動型Webhook",
        enabled: true,
      },
      {
        id: "f15",
        name: "カスタムコネクタ",
        description: "カスタムシステム統合",
        enabled: false,
      },
    ],
    version: "2.5.0",
    ...
    features: [
      {
        id: "f19",
        name: "自動バックアップ",
        description: "スケジュール自動バックアップ",
        enabled: true,
      },
      {
        id: "f20",
        name: "ポイントインタイムリカバリ",
        description: "特定時点への復元",
        enabled: true,
      },
      {
        id: "f21",
        name: "クロスリージョンバックアップ",
        description: "地域をまたいだバックアップ",
        enabled: false,
      },
    ],
    version: "0.9.5",
    ...
    features: [
      {
        id: "f22",
        name: "ワークフローエディタ",
        description: "ビジュアルワークフロー作成",
        enabled: false,
      },
      {
        id: "f23",
        name: "条件分岐",
        description: "複雑な条件分岐処理",
        enabled: false,
      },
      {
        id: "f24",
        name: "スケジューラー",
        description: "タイムベースの実行",
        enabled: false,
      },
    ],
    version: "0.1.0",
  ...
  "tenant-1": [
    {
      ...
      enabled: true,
      enabledFeatures: ["f1", "f2"],
    },
    {
      serviceId: "service-messaging",
      enabled: true,
      enabledFeatures: ["f4", "f5"],
    },
...
export const getTenantServices = async (
  ...
  try {
    const response = await apiClient.get<TenantServiceConfig>(
...
export const updateTenantService = async (
  ...
  try {
    ...
    const existingIndex = mockTenantServices[tenantId].findIndex(
...
export const toggleTenantServiceFeature = async (
  ...
  try {
    ...
    const assignment = mockTenantServices[tenantId].find(
      (a) => a.serviceId === serviceId
    );
    if (assignment) {
      if (enabled && !assignment.enabledFeatures.includes(featureId)) {
        ...
        assignment.enabledFeatures = assignment.enabledFeatures.filter(
          (id) => id !== featureId
        );
      }
    }
